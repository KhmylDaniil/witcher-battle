...
namespace Sindie.ApiService.Storage.Postgresql.Migrations
{
    ...
    [Migration("20220506084327_addUpdateBagItemsLogicFields")]
    partial class addUpdateBagItemsLogicFields
    {
            ...
            modelBuilder.Entity("Sindie.ApiService.Core.Entities.NotificationTradeRequest", b =>
                {
                    ...
                    b.HasOne("Sindie.ApiService.Core.Entities.Bag", "ReceiveBag")
                        .WithMany("NotificationsTradeRequestReceive")
                        .HasForeignKey("ReceiveBagId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sindie.ApiService.Core.Entities.Bag", b =>
                {
                    ...
                    b.Navigation("NotificationsTradeRequestReceive");
