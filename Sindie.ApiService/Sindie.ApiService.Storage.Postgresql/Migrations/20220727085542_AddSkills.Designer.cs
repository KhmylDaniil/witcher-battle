...
namespace Sindie.ApiService.Storage.Postgresql.Migrations
{
    ...
    [Migration("20220727085542_AddSkills")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sindie.ApiService.Core.Entities.BleedEffect", b =>
                {
                    ...
                    b.ToTable("BleedEffects", "Battles");
            ...
            modelBuilder.Entity("Sindie.ApiService.Core.Entities.BleedEffect", b =>
                {
                    b.HasOne("Sindie.ApiService.Core.Entities.Effect", null)
                        .WithOne()
                        .HasForeignKey("Sindie.ApiService.Core.Entities.BleedEffect", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
