...
namespace PilotProject.DbContext
{
	public class TestDbContext : IDisposable
	{
		...
		/// Идентификатор игры
		/// </summary>
		public static readonly Guid GameId = new Guid("8094e0d0-3148-4791-9053-9667cbe137d9");

		/// <summary>
		/// Идентификатор шаблона тела
		/// </summary>
		public static readonly Guid BodyTemplateId = new Guid("8094a0d0-3148-4791-9053-9667abe137d9");
		...
		internal AppDbContext CreateInMemoryContext(Action<AppDbContext> dbSeeder = null)
		{
