...
//		public async Task CreateCreatureTemplateAsync([FromBody] CreateCreatureTemplateCommand request, CancellationToken cancellationToken)
//		{
...
//		[SwaggerResponse(StatusCodes.Status200OK)]
//		[SwaggerResponse(StatusCodes.Status400BadRequest, type: typeof(ProblemDetails))]
//		public async Task ChangeCreatureTemplateAsync([FromBody] Core.Contracts.CreatureTemplateRequests.ChangeCreatureTemplate.ChangeCreatureTemplateCommand request, CancellationToken cancellationToken)
//		{
//			await _mediator.Send(
//				request == null
//				? throw new ArgumentNullException(nameof(request))
//				: new Core.Requests.CreatureTemplateRequests.ChangeCreatureTemplate.ChangeCreatureTemplateCommand(
//					id: request.Id,
//					gameId: request.GameId,
//					imgFileId: request.ImgFileId,
//					bodyTemplateId: request.BodyTemplateId,
