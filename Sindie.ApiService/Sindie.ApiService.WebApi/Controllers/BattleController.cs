...
namespace Sindie.ApiService.WebApi.Controllers
{
	...
	public class BattleController: ApiControllerBase
	{
		...
		//[SwaggerResponse(StatusCodes.Status200OK)]
		//[SwaggerResponse(StatusCodes.Status400BadRequest, type: typeof(ProblemDetails))]
		//public async Task<Unit> AttackAsync([FromQuery] AttackCommand command, CancellationToken cancellationToken)
		//{
		...
		//[SwaggerResponse(StatusCodes.Status200OK)]
		//[SwaggerResponse(StatusCodes.Status400BadRequest, type: typeof(ProblemDetails))]
		//public async Task<Unit> TreatEffectByIdAsync([FromQuery] HealEffectCommand request, CancellationToken cancellationToken)
		//{
