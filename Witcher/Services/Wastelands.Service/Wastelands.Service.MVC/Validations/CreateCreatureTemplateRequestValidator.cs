...
{
	public class CreateCreatureTemplateRequestValidator : AbstractValidator<CreateCreatureTemplateRequest>
	{
		public CreateCreatureTemplateRequestValidator()
		{
			RuleFor(x => x.BodyTemplateId).GreaterThan(0).WithMessage(ExceptionMessages.ValueMustBePositive);
