...
{
	public class UpdateBodyTemplatePartRequestValidator : AbstractValidator<UpdateBodyTemplatePartRequest>
	{
		public UpdateBodyTemplatePartRequestValidator()
		{
			// BodyTemplateId/PartId намеренно не валидируются здесь — см. аналогичное примечание в
			// UpdateCharacterRequestValidator, оба приходят из маршрута, а не из тела запроса.
