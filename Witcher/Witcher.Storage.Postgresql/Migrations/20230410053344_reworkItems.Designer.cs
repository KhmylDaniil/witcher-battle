...
namespace Witcher.Storage.Postgresql.Migrations
{
    ...
    [Migration("20230410053344_reworkItems")]
    partial class reworkItems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Witcher.Core.Entities.Bag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Witcher.Core.Entities.Weapon", b =>
                {
                    ...
                    b.Property<Guid?>("EquippedByCharacterId")
                        .HasColumnType("uuid")
                        .HasColumnName("EquippedByCharacterId")
                        .HasComment("Экипировавший персонаж");

                    b.HasIndex("EquippedByCharacterId");
            ...
            modelBuilder.Entity("Witcher.Core.Entities.WeaponTemplate", b =>
                {
                    ...
                    b.ToTable("WeaponTeemplates", "Items");
            ...
            modelBuilder.Entity("Witcher.Core.Entities.Bag", b =>
                {
                    b.HasOne("Witcher.Core.Entities.Character", "Character")
                        .WithOne("Bag")
                        .HasForeignKey("Witcher.Core.Entities.Bag", "CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Witcher.Core.Entities.Item", b =>
                {
                    b.HasOne("Witcher.Core.Entities.Bag", "Bag")
                        .WithMany("Items")
                        .HasForeignKey("BagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Witcher.Core.Entities.Weapon", b =>
                {
                    b.HasOne("Witcher.Core.Entities.Character", "EquippedByCharacter")
                        .WithMany("EquippedWeapons")
                        .HasForeignKey("EquippedByCharacterId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("EquippedByCharacter");
                });
                    ...
                    b.OwnsMany("Witcher.Core.Entities.AppliedCondition", "AppliedConditions", b1 =>
                        {
                            ...
                            b1.ToTable("WeaponTeemplates_AppliedConditions", "Items");
                    ...
                    b.OwnsMany("Witcher.Core.Entities.DefensiveSkill", "DefensiveSkills", b1 =>
                        {
                            ...
                            b1.ToTable("WeaponTeemplates_DefensiveSkills", "Items");
