...
namespace Witcher.Core.DAL.Entities.Effects
{
	...
	public sealed class ComplexHead1CritEffect : CritEffect, ICrit
	{
		...
		public static ComplexHead1CritEffect Create(Creature creature, CreaturePart aimedPart, string name)
		{
			...
			CheckExistingEffectAndRemoveStabilizedEffect<ComplexHead1CritEffect>(creature, aimedPart);
			return new ComplexHead1CritEffect(creature, aimedPart, name + $" {teeth} штук");
		}
